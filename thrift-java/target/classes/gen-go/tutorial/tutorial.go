...
// lists and exception lists are specified using the exact same syntax as
// field lists in struct or exception definitions.
func (p *CalculatorClient) Health(ctx context.Context) (r bool, err error) {
  var _args0 CalculatorHealthArgs
  var _result1 CalculatorHealthResult
  if err = p.Client_().Call(ctx, "health", &_args0, &_result1); err != nil {
    return
  }
  return _result1.GetSuccess(), nil
}

func (p *CalculatorClient) Ping(ctx context.Context) (r string, err error) {
  var _args2 CalculatorPingArgs
  var _result3 CalculatorPingResult
...
func (p *CalculatorClient) Add(ctx context.Context, num1 int32, num2 int32) (r int32, err error) {
  var _args4 CalculatorAddArgs
  _args4.Num1 = num1
  _args4.Num2 = num2
  var _result5 CalculatorAddResult
  if err = p.Client_().Call(ctx, "add", &_args4, &_result5); err != nil {
    return
  }
...
func (p *CalculatorClient) Calculate(ctx context.Context, logid int32, w *Work) (r int32, err error) {
  ...
  _args6.Logid = logid
  _args6.W = w
  var _result7 CalculatorCalculateResult
  if err = p.Client_().Call(ctx, "calculate", &_args6, &_result7); err != nil {
    return
  }
  switch {
...
func NewCalculatorProcessor(handler Calculator) *CalculatorProcessor {
  ...
  self9.AddToProcessorMap("health", &calculatorProcessorHealth{handler:handler})
...
type calculatorProcessorHealth struct {
  handler Calculator
}

func (p *calculatorProcessorHealth) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := CalculatorHealthArgs{}
...
type CalculatorHealthArgs struct {
}

func NewCalculatorHealthArgs() *CalculatorHealthArgs {
  return &CalculatorHealthArgs{}
}

func (p *CalculatorHealthArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *CalculatorHealthArgs) Write(oprot thrift.TProtocol) error {
...
func (p *CalculatorHealthArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("CalculatorHealthArgs(%+v)", *p)
}

// Attributes:
//  - Success
type CalculatorHealthResult struct {
  Success *bool `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewCalculatorHealthResult() *CalculatorHealthResult {
  return &CalculatorHealthResult{}
}

var CalculatorHealthResult_Success_DEFAULT bool
func (p *CalculatorHealthResult) GetSuccess() bool {
  if !p.IsSetSuccess() {
    return CalculatorHealthResult_Success_DEFAULT
  }
return *p.Success
}
func (p *CalculatorHealthResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *CalculatorHealthResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *CalculatorHealthResult)  ReadField0(iprot thrift.TProtocol) error {
...
func (p *CalculatorHealthResult) Write(oprot thrift.TProtocol) error {
...
func (p *CalculatorHealthResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
...
func (p *CalculatorHealthResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("CalculatorHealthResult(%+v)", *p)
}
...
var CalculatorPingResult_Success_DEFAULT string
func (p *CalculatorPingResult) GetSuccess() string {
  if !p.IsSetSuccess() {
    return CalculatorPingResult_Success_DEFAULT
  }
return *p.Success
}
func (p *CalculatorPingResult) IsSetSuccess() bool {
  return p.Success != nil
}
...
func (p *CalculatorPingResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  p.Success = &v
...
func (p *CalculatorPingResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
